...
/// Classe `LoginWithGoogle`.
/// Representa o caso de uso para realizar login com Google.
/// Encapsula a lógica de autenticação com Google para separá-la do restante da aplicação.
class LoginWithGoogle {
  // Instância do AuthRepository, que lida com as operações de autenticação.
  final AuthRepository authRepository;

  // Construtor da classe `LoginWithGoogle`.
  ...
  // Não requer parâmetros adicionais, pois a autenticação com Google usa a conta conectada.
